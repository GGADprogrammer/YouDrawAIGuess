            ...
            switch (msg.what) {
                case 0:
                    ...
                    if ((msg.arg1==0&&!isHandled[level]) || (msg.arg1==1&&!isHandled[timer])) {
                        ...
                        final String url = "http://111.229.170.54:8080/guessServer/SaveServlet";
                        final String url1 = "http://111.229.170.54:8080/guessServer/RecognizeServlet";
                        final String score_url = "http://111.229.170.54:8080/guessServer/ScoreServlet";
                        final String update_url = "http://111.229.170.54:8080/guessServer/UpdateServlet";
